document.addEventListener("DOMContentLoaded", () => {
    setTimeout(() => {
        ...
        if (!btnGenerate || !btnValidate || !cpfToValid || !cpfGenerated) {
            console.error("Algum elemento não foi encontrado no DOM.", [cpfToValid, btnValidate, cpfGenerated, btnGenerate])
            return [cpfToValid, btnValidate, cpfGenerated, btnGenerate]
        }
